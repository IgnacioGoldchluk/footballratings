defmodule FootballratingsWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use FootballratingsWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import FootballratingsWeb.ConnCase
    end
  end

  setup tags do
    Footballratings.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_users(%{conn: conn}) do
    users = Footballratings.AccountsFixtures.users_fixture()
  ...
  def log_in_users(conn, users) do
    token = Footballratings.Accounts.generate_users_session_token(users)
