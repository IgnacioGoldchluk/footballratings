defmodule FootballratingsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FootballratingsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FootballratingsWeb.Gettext, "errors", msg, opts)
    end
  end
