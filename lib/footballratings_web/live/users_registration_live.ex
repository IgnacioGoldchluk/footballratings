defmodule FootballratingsWeb.UsersRegistrationLive do
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        ...
        <:subtitle>
          Already registered?
          <.link navigate={~p"/users/log_in"} class="link-primary font-semibold hover:underline">
            Sign in
          </.link>
          to your account now.
        </:subtitle>
      ...
      >
        ...
        <:actions>
          <.button phx-disable-with="Creating account..." class="btn-primary">
            Create an account
          </.button>
        </:actions>
      </.simple_form>
