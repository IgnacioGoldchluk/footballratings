defmodule Footballratings.Accounts.Users do
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Footballratings.Repo)
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, Footballratings.Repo)
  ...
  """
  def valid_password?(%Footballratings.Accounts.Users{hashed_password: hashed_password}, password)
